...
//        HttpGet httpGet = new HttpGet( "http://10.10.41.251:8081"+ "jobs/overview");
//        //System.out.println(url + "jobs/overview");
//        HttpResponse execute = httpClient.execute(httpGet);
//        HttpEntity entity = execute.getEntity();
//        System.out.println(entity);
...
//        HttpClient httpClient = HttpClients.createDefault();
//        //String url = FlinkWebUrlUtil.getProxyFlinkUrl(applicationName);
//        HttpGet httpGet = new HttpGet("http://10.10.41.251:8081" + "jobs/" + jobId);
...
//        HttpClient httpClient = HttpClients.createDefault();
//        //String url = FlinkWebUrlUtil.getProxyFlinkUrl(applicationName);
//        HttpGet httpGet = new HttpGet("http://10.10.41.251:8081" + "jobs/" + jobId + "/yarn-cancel");
...
//        HttpClient httpClient = HttpClients.createDefault();
//        //String url = FlinkWebUrlUtil.getProxyFlinkUrl(applicationName);
//        HttpGet httpGet = new HttpGet("http://10.10.41.251:8081" + "v1/jars");
//        //System.out.println(url + "jars");
//        HttpResponse execute = httpClient.execute(httpGet);
//        HttpEntity entity = execute.getEntity();
//        System.out.println(entity);
...
//        HttpPost uploadFile = new HttpPost("http://10.10.41.251:8081" + "/jars/upload");
//        //System.out.println(url + "/jars/upload");
//        MultipartEntityBuilder builder = MultipartEntityBuilder.create();
//        builder.addBinaryBody(
//                "jarfile",
...
//     */
//
//    public static void flinkJarRun(String applicationName) throws Exception {
//        //String flinkWebUrl = FlinkWebUrlUtil.getRealFlinkUrl(applicationName);
//        //System.out.println(flinkWebUrl);
//        HttpClient httpClient = HttpClients.createDefault();
//        //HttpPost httpPost = new HttpPost("http://10.10.41.251:8081/v1/jars/c00a8e45-7180-4eed-af14-f30f2102fb86_tock1.12.4-1.0-SNAPSHOT.jar/run?entry-class=flink.Tockjson5&program-args=--min 25");
...
//                                            //http://10.10.41.251:8081/v1/jars/c00a8e45-7180-4eed-af14-f30f2102fb86_tock1.12.4-1.0-SNAPSHOT.jar/run?entry-class=flink.Tockjson5&program-args=--min 15
//        HttpPost httpPost = new HttpPost("http://10.10.41.251:8081/v1/jars/c00a8e45-7180-4eed-af14-f30f2102fb86_tock1.12.4-1.0-SNAPSHOT.jar/run?entry-class=flink.Tockjson5&program-args=--min 15");
